...
const SignUpForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-orange-50">
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-center text-orange-600">Create Your Swiggy Account</h2>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`mt-1 block w-full px-4 py-2 border ${errors.username ? 'border-red-500' : 'border-gray-300'} rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500`}
          />
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className={`mt-1 block w-full px-4 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500`}
          />
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-700">Already have an account? <Link to="/login" className="text-orange-600 hover:underline">Sign In</Link></p>
        </div>
      </form>
    </div>
  );
