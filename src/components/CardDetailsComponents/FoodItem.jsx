...
//   const maxLength = 100;
//   const { name, defaultPrice, price, description, imageId, id,category } =
//     item.card.info;
...
//       const existingItemCategory = prevItems.find((item) => item.category !== category);
...
//         return [{ id, name, price: itemPrice, quantity: 1,category }]
//       }
